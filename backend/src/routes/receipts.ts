...
router.patch('/:id/approve', roleGuard(['ADMIN', 'SECTION_CHIEF']), receiptController.approve)
router.patch('/:id/cancel', roleGuard(['ADMIN', 'SECTION_CHIEF']), receiptController.cancel)
